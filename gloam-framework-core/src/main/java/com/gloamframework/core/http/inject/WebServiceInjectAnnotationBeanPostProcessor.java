package com.gloamframework.core.http.inject;
        ...
        do {
            ...
            ReflectionUtils.doWithLocalFields(targetClass, field -> {
                ...
                if (ann != null) {
                    ...
                    boolean required = determineRequiredStatus(ann);
                    currElements.add(new WebServiceInjectAnnotationBeanPostProcessor.AutowiredFieldElement(field, required));
                }
            });
                        ...
                        if (value != null || this.required) {
                            ...
                            if (autowiredBeanNames.size() == 1) {
                                ...
                                if (beanFactory.containsBean(autowiredBeanName) &&
                                    ...
                                    this.cachedFieldValue = new WebServiceInjectAnnotationBeanPostProcessor.ShortcutDependencyDescriptor(
                            ...
                            if (autowiredBeans.size() == argumentCount) {
                                ...
                                for (int i = 0; i < paramTypes.length; i++) {
                                    ...
                                    if (beanFactory.containsBean(autowiredBeanName) &&
                                        ...
                                        cachedMethodArguments[i] = new WebServiceInjectAnnotationBeanPostProcessor.ShortcutDependencyDescriptor(
