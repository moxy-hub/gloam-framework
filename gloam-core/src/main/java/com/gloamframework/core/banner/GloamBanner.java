package com.gloamframework.core.banner;
...
public class GloamBanner implements Banner {
    ...
    private static final String SPRING_CLOUD_VERSION = "2021.0.9";
    private static final String SPRING_CLOUD_ALIBABA_VERSION = "2021.0.5.0";
    ...
    public void printBanner(Environment environment, Class<?> sourceClass, PrintStream printStream) {
        ...
        String author = "  Moxy";
        String springCloudVersion = "  v-" + SPRING_CLOUD_VERSION;
        String springAlibabaVersion = "  v-" + SPRING_CLOUD_ALIBABA_VERSION;
        // 打印版本
