package com.gloamframework.data.permission.db;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.collection.CollectionUtil;
import com.gloamframework.common.collection.SetUtils;
import com.gloamframework.data.mybatis.flex.interceptor.FlexInterceptor;
import com.gloamframework.data.mybatis.flex.parser.FlexJsqlParserSupport;
...
import com.gloamframework.data.permission.util.MybatisPluginUtils;
...
@Slf4j
public class DataPermissionDatabaseInterceptor extends FlexJsqlParserSupport implements FlexInterceptor {
    ...
    public void beforeQuery(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) {
        ...
        MybatisPluginUtils.MPBoundSql mpBs = MybatisPluginUtils.mpBoundSql(boundSql);
        try {
            // 初始化上下文
    ...
    public void beforePrepare(StatementHandler sh, Connection connection, Integer transactionTimeout) {
        MybatisPluginUtils.MPStatementHandler mpSh = MybatisPluginUtils.mpStatementHandler(sh);
        ...
        if (sct == SqlCommandType.UPDATE || sct == SqlCommandType.DELETE) {
            ...
            MybatisPluginUtils.MPBoundSql mpBs = mpSh.mPBoundSql();
            try {
                // 初始化上下文
                ContextHolder.init(rules);
                // 处理 SQL
