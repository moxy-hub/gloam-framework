package com.gloamframework.property.conversion;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.core.util.StrUtil;
import com.gloamframework.property.MappingPropertyDefinition;
 ...
 * <li>如果spring不支持转换，则会对传入的class进行解析，如果存在标识了{@link com.gloamframework.property.annotation.MappingConfigurationProperty}注解的字段进行映射匹配
